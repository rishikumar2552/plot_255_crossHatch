...
// right slash direction section
{
    ...
    var svgNS = "http://www.w3.org/2000/svg";  
      ...
      //**** <FOR THE vertical line ARTSTYLE> ******
    var recta = document.createElementNS(svgNS, 'line');
    recta.setAttributeNS(null, 'x1', x+Math.random()*5);
    recta.setAttributeNS(null, 'y1',  y+Math.random()*5);
...
//  console.log("a=",a);
   ...
   var downFilename = "Plotter_random_hatch_";
...
function downloadGCode2() {
    ...
    downlink2.href=url;
    var name="Plotter_random_hatch"+Math.floor((Math.random()*1000)+1) +  '.gcode'
